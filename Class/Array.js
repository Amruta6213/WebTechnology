...
//datascripting using data array used for asked ques to array
console.log(Array.isArray("Amruta"))//false bcoz "Amruta"is string not array
console.log(Array.from("amruta"))//convert into array
console.log(Array.from({name:"Amruta"}))//give empty array directly not convert into key value.objects are not iterable
